...
def split_video_into_scenes(
    video_path: str,
    output_path: str,
    detectors: List[SceneDetector] = [ContentDetector(threshold=12.0, min_scene_len=12)],
) -> List[str]:
    """
...
def save_video_to_image_sequence(video_path: str, output_images_path: str, image_prefix: str = "frame_") -> List[str]:
    """
    Converts an entire video (or video clip) into a sequence of its frames.
    Filename format: image_prefix<frame_number>.jpg
    ...
    try:
        ...
        while True:
            ...
            image_filename: str = os.path.join(output_images_path, f"{image_prefix}{frame_num:04d}.jpg")
